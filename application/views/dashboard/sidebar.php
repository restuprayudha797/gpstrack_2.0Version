        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="menu_1" class="collapse show dropdown-nav">
              <li>
                <a href="<?= base_url('admin') ?>" class="<?= ($title == "User Data") ? 'active' : '' ?>">Data User</a>
              </li>
              <li>
                <a href="<?= base_url('admin/payment') ?>" class="<?= ($title == "Pembayaran") ? 'active' : '' ?>">Pembayaran</a>
              </li>
              <li>
                <a href="<?= base_url('admin/serialNumber') ?>" class="<?= ($title == "Serial Number") ? 'active' : '' ?>">Serial Number</a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item <?= ($title == "Laporan") ? 'active' : '' ?>">
            <a href="<?= base_url('admin/report') ?>">
              <span class="icon">
                <i class="lni lni-bar-chart fw-bold"></i>
              </span>
